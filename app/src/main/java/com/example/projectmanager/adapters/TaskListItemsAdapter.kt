    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.ib_done_list_name.setOnClickListener {
                ...
                } else Toast.makeText(context, "Please enter a name in the list", Toast.LENGTH_SHORT).show()
            }
            ...
            holder.itemView.ib_done_edit_list_name.setOnClickListener {
                ...
                if (listName.isNotEmpty()) if (context is TaskListActivity) context.editTaskList(position, listName, model)
                else Toast.makeText(context, "Please Enter List Name", Toast.LENGTH_SHORT).show()
            }
            ...
            holder.itemView.ib_done_card_name.setOnClickListener {
                ...
                if (cardName.isNotEmpty()) {
                    if (context is TaskListActivity) {
                        context.createCardToTaskList(position, cardName)
                    }
                } else Toast.makeText(context, "Please enter a card name", Toast.LENGTH_SHORT).show()
            }
            ...
            adapter.setOnClickListener(
                object : CardListItemsAdapter.OnClickListener{
                    override fun onClick(cardPosition: Int) {
                        if (context is TaskListActivity) context.cardDetails(position, cardPosition)
                    }
                }
            )

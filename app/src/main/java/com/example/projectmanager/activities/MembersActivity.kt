...
class MembersActivity : BaseActivity() {
    ...
    private fun setActionBar() {
        ...
        tb_members_activity.setNavigationOnClickListener { onBackPressed() }
    }
    ...
    private inner class SendNotificationToUserAsyncTask(val boardName: String, val token: String): AsyncTask<Any, Void, String>() {
        ...
        override fun doInBackground(vararg params: Any?): String {
            ...
            try {
                ...
                dataObject.put(Constants.FCM_KEY_TITLE, "Addigned to the board $boardName")
        ...
        override fun onPostExecute(result: String?) {
            ...
            hideProgressDialog()
            Log.i("MembersActivity Async: ", result!!)
        }

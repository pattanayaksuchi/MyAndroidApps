...
class LabelColorListItemsAdapter(private val context: Context, private val list: ArrayList<String>, private val mSelectedColor: String) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            if (item == mSelectedColor) holder.itemView.iv_selected_color.visibility = View.VISIBLE
